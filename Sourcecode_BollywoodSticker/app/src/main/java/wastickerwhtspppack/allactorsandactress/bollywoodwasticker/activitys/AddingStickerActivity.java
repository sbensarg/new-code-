...
public abstract class AddingStickerActivity extends BaseStickerActivity {
    ...
    protected void addStickerPackToWhatsApp(String identifier, String stickerPackName) {
        ...
        try {
            ...
            Toast.makeText(this, R.string.Bollywood_error_adding_sticker_pack, Toast.LENGTH_LONG).show();
        }
    }
            ...
            if (resultCode == Activity.RESULT_CANCELED) {
                if (data != null) {
                    ...
                    if (validationError != null) {
                        ...
                        Log.e("AddingStickerActivity", "Validation failed:" + validationError);
                    }
                } else {
    ...
    public static final class StickerPackNotAddedMessageFragment extends DialogFragment {
        ...
        private void launchWhatsAppPlayStorePage() {
            if (getActivity() != null) {
                ...
                final boolean whatsAppInstalled = ListChecking.isPackageInstalled(ListChecking.CONSUMER_WHATSAPP_PACKAGE_NAME, packageManager);
                final boolean smbAppInstalled = ListChecking.isPackageInstalled(ListChecking.SMB_WHATSAPP_PACKAGE_NAME, packageManager);
                ...
                if (whatsAppInstalled && smbAppInstalled) {
                    ...
                    launchPlayStoreWithUri(playPackageLinkPrefix + ListChecking.CONSUMER_WHATSAPP_PACKAGE_NAME);
                } else if (smbAppInstalled) {
                    launchPlayStoreWithUri(playPackageLinkPrefix + ListChecking.SMB_WHATSAPP_PACKAGE_NAME);
                }
            }
        }
        ...
        private void launchPlayStoreWithUri(String uriString) {
            ...
            try {
                ...
                Toast.makeText(getActivity(), R.string.Bollywood_cannot_find_play_store, Toast.LENGTH_LONG).show();
            }
        }
    }
}
