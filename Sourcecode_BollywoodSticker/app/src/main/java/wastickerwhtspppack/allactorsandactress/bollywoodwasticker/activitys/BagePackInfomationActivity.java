...
public class BagePackInfomationActivity extends BaseStickerActivity {

    private static final String TAG = "BagePackInfomationActivity";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_package_information);
        final String trayIconUriString = getIntent().getStringExtra(PackDetailsActivity.EXTRA_STICKER_PACK_TRAY_ICON);
        final String website = getIntent().getStringExtra(PackDetailsActivity.EXTRA_STICKER_PACK_WEBSITE);
        final String email = getIntent().getStringExtra(PackDetailsActivity.EXTRA_STICKER_PACK_EMAIL);
        final String privacyPolicy = getIntent().getStringExtra(PackDetailsActivity.EXTRA_STICKER_PACK_PRIVACY_POLICY);
        ...
        try {
            ...
            final Drawable emailDrawable = getDrawableForAllAPIs(R.drawable.email_icon);
    ...
    private void launchEmailClient(String email) {
        ...
        startActivity(Intent.createChooser(emailIntent, getResources().getString(R.string.Bollywood_info_send_email_to_prompt)));
    }
